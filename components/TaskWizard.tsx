  ...
  return (
    <div className="max-w-2xl mx-auto animate-fade-in">
      ...
      <div className="mb-8 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100/80 dark:bg-slate-800 text-[11px] font-mono text-slate-600 dark:text-slate-400 tracking-wider uppercase mb-3">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1.5">Birkaç adımda eksiksiz bir görev hazırla</p>
      </div>
      ...
      <div className="surface-card p-7 mb-6 shadow-soft-md">
        <div className="mb-6">
          <h2 className="font-display font-bold text-xl tracking-tight text-slate-900 dark:text-slate-100">
            {STEPS[step - 1].title}
          </h2>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">{STEPS[step - 1].desc}</p>
        </div>
        ...
        <div key={step} className="animate-slide-in">
          ...
          {step === 1 && (
            <div className="space-y-5">
              <div>
                <Label htmlFor="title" className="mb-2 block text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider">
                ...
                <div className="flex items-center justify-between mt-1.5">
                  {data.title.length > 0 && data.title.length < 3
                    ...
                    : <span />}
                  <span className="text-[11px] font-mono text-slate-400 dark:text-slate-500 tabular-nums">{data.title.length}/100</span>
                </div>
              </div>
              <div>
                <Label htmlFor="desc" className="mb-2 block text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider">
                  Açıklama <span className="text-slate-400 dark:text-slate-500 normal-case font-normal">· isteğe bağlı</span>
                </Label>
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div>
                <Label className="mb-3 block text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider">
                  Kime Atanacak?
                </Label>
              ...
              <div>
                <Label className="mb-3 block text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider">Öncelik</Label>
              ...
              <div>
                <Label className="mb-3 block text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider">Başlangıç Durumu</Label>
          ...
          {step === 3 && (
            <div className="space-y-6">
              <div>
                <Label htmlFor="duedate" className="mb-2 block text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider">
                  Son Tarih <span className="text-slate-400 dark:text-slate-500 normal-case font-normal">· isteğe bağlı</span>
                </Label>
              ...
              <div>
                <Label className="mb-2 block text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider">
                  Etiketler <span className="text-slate-400 dark:text-slate-500 normal-case font-normal">· isteğe bağlı</span>
                </Label>
                ...
                <p className="text-[11px] text-slate-400 dark:text-slate-500 mt-1.5">Enter veya virgül ile ekle</p>
                {data.tags.length > 0 && (
            ...
            <div className="space-y-4">
              ...
              {data.checklist.length === 0 ? (
                <div className="text-center py-10 rounded-xl border border-dashed border-slate-200 dark:border-slate-700 bg-slate-50/40 dark:bg-slate-800/30">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-300 font-medium">Henüz alt görev eklenmedi</p>
                  <p className="text-[11px] text-slate-400 dark:text-slate-500 mt-1">Bu adım isteğe bağlıdır — istersen atlayabilirsin</p>
                </div>
              ) : (
                <div className="space-y-1.5">
                  {data.checklist.map((item, idx) => (
                    <div key={item.id} className="flex items-center gap-3 py-2.5 px-3.5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 group hover:bg-white dark:hover:bg-slate-700/50 hover:border-slate-200 dark:hover:border-slate-600 transition-colors animate-scale-in">
                      <span className="text-[11px] font-mono text-slate-400 dark:text-slate-500 w-5 tabular-nums">{String(idx + 1).padStart(2, "0")}</span>
