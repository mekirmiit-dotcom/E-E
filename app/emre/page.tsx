            ...
            {filteredTasks.map((task) => {
              ...
              return (
                <button
                  ...
                  className="w-full text-left glass-card rounded-2xl p-4 hover:shadow-md transition-all hover:scale-[1.005] group border border-transparent hover:border-amber-100 dark:hover:border-amber-900"
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      ...
                      <h4 className="font-medium text-sm text-slate-800 dark:text-slate-200 group-hover:text-amber-700 dark:group-hover:text-amber-300 transition-colors leading-snug">
                        {task.title}
                      </h4>
                      {task.description && (
